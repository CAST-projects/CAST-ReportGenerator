...
namespace CastReporting.Mediation
{
    ...
    /// </summary>
    public class ImagingProxy : WebClient, IImagingProxy
    {
        #region ATTRIBUTES
        ...
        /// </summary>
        public ImagingProxy(string login, string password, bool apiKey, bool validateCertificate, CookieContainer cookies = null, bool autoRedirect = true)
        {
