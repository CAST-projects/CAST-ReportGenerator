...
namespace CastReporting.Domain.Imaging.Interfaces
{
    public interface ISnapshotExplorer : IDisposable
    {
        ...
        IEnumerable<CommonCategories> GetCommonCategories(WSImagingConnection connection);
        ...
        IEnumerable<Result> GetOmgTechnicalDebtDetailsForSnapshots(string appHRef, int indexId, string snapshotIds);
    }
}
