...
namespace CastReporting.Repositories
{
    ...
    public class ImagingRepository : IImagingRepository
    {
        ...
        /// 
        /// </summary>
        protected IImagingProxy _Client;
        ...
        public ImagingRepository(WSImagingConnection connection, IImagingProxy client)
        {
            _Client = new ImagingProxy(connection.Login, connection.Password, connection.ApiKey, connection.ServerCertificateValidation, client?.GetCookieContainer());

            _CurrentConnection = connection.Url;
            _CurrentApiKey = connection.ApiKey;
        }

        public IImagingProxy GetClient()
        {
            return _Client;
        }
        ...
        bool IImagingRepository.IsServiceValid()
        {
        ...
        string IImagingRepository.GetServerVersion()
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<CastDomain> IImagingRepository.GetDomains()
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<Application> IImagingRepository.GetApplicationsByDomain(string domainHRef)
        {
        ...
        /// <returns></returns>
        Application IImagingRepository.GetApplication(string hRef)
        {
        ...
        #region Snapshots
        List<string> IImagingRepository.GetFileContent(string domainHRef, string siteId, string fileId, int startLine, int endLine)
        {
        ...
        AssociatedValue IImagingRepository.GetAssociatedValue(string domainHRef, string snapshotId, string objectId, string metricId)
        {
        ...
        AssociatedValuePath IImagingRepository.GetAssociatedValuePath(string domainHRef, string snapshotId, string objectId, string metricId)
        {
            var requestUrl = string.Format(_query_findings, domainHRef, objectId, snapshotId, metricId);
        ...
        AssociatedValueGroup IImagingRepository.GetAssociatedValueGroup(string domainHRef, string snapshotId, string objectId, string metricId)
        {
            var requestUrl = string.Format(_query_findings, domainHRef, objectId, snapshotId, metricId);
        ...
        AssociatedValueObject IImagingRepository.GetAssociatedValueObject(string domainHRef, string snapshotId, string objectId, string metricId)
        {
            var requestUrl = string.Format(_query_findings, domainHRef, objectId, snapshotId, metricId);
        ...
        IEnumerable<CodeFragment> IImagingRepository.GetSourceCode(string domainHRef, string snapshotId, string objectId)
        {
        ...
        TypedComponent IImagingRepository.GetTypedComponent(string domainHRef, string componentId, string snapshotId)
        {
        ...
        IEnumerable<Component> IImagingRepository.GetComponents(string snapshotHref, string businessCriteria, int count)
        {
        ...
        IEnumerable<ComponentWithProperties> IImagingRepository.GetComponentsWithProperties(string snapshothref, int bcId, string prop1, string prop2, string order1, string order2, int count)
        {
        ...
        IEnumerable<Component> IImagingRepository.GetComponentsByModule(string domainId, int moduleId, int snapshotId, string businessCriteria, int count)
        {
        ...
        IEnumerable<Transaction> IImagingRepository.GetTransactions(string snapshotHref, string businessCriteria, int count)
        {
        ...
        IEnumerable<CommonCategories> IImagingRepository.GetCommonCategories()
        {
        ...
        IEnumerable<CommonTaggedApplications> IImagingRepository.GetCommonTaggedApplications()
        {
        ...
        IEnumerable<IfpugFunction> IImagingRepository.GetIfpugFunctions(string snapshotHref, int count)
        {
        ...
        IEnumerable<IfpugFunction> IImagingRepository.GetIfpugFunctionsEvolutions(string snapshotHref, int count)
        {
        ...
        IEnumerable<OmgFunction> IImagingRepository.GetOmgFunctionsEvolutions(string snapshotHref, int count)
        {
        ...
        IEnumerable<OmgFunctionTechnical> IImagingRepository.GetOmgFunctionsTechnical(string snapshotHref, int count)
        {
        ...
        IEnumerable<MetricTopArtifact> IImagingRepository.GetMetricTopArtefact(string snapshotHref, string RuleId, int count)
        {
        ...
        IEnumerable<Violation> IImagingRepository.GetViolationsInActionPlan(string snapshotHref, int count)
        {
        ...
        /// <returns></returns>
        IEnumerable<Snapshot> IImagingRepository.GetSnapshotsByApplication(string applicationHRef)
        {
        ...
        /// <param name="applicationHRef"></param>
        /// <returns></returns>
        IEnumerable<Domain.Imaging.System> IImagingRepository.GetSystemsByApplication(string applicationHRef)
        {
            return ListSet<Domain.Imaging.System>(applicationHRef);
        }
        ...
        /// <param name="hRef"></param>
        /// <returns></returns>
        Snapshot IImagingRepository.GetSnapshot(string hRef)
        {
        ...
        /// <returns></returns>
        RuleDescription IImagingRepository.GetSpecificRule(string domain, string ruleId)
        {
        ...
        /// <returns></returns>
        IEnumerable<Result> IImagingRepository.GetRulesViolations(string snapshotHRef, string criticity, string businessCriteria)
        {
        ...
        /// <returns></returns>
        IEnumerable<RuleDetails> IImagingRepository.GetRulesDetails(string domain, int businessCriteria, long snapshotId)
        {
        ...
        IEnumerable<Contributor> IImagingRepository.GetCriteriaContributors(string domain, string technicalCriteria, long snapshotId)
        {
        ...
        /// <param name="snapshotHRef"></param>
        /// <returns></returns>
        IEnumerable<ActionPlan> IImagingRepository.GetActionPlanBySnapshot(string snapshotHRef)
        {
        ...
        /// <param name="hRef"></param>
        /// <returns></returns>
        IEnumerable<Module> IImagingRepository.GetModules(string hRef)
        {
        ...
        /// <param name="hRef"></param>
        /// <returns></returns>
        Module IImagingRepository.GetModule(string hRef)
        {
        ...
        IEnumerable<DeltaComponent> IImagingRepository.GetDeltaComponents(string levelHRef, string snapshotId, string previousSnapshotId, string status, string technology)
        {
        ...
        /// <returns></returns>
        IEnumerable<Result> IImagingRepository.GetComplexityIndicators(string snapshotHRef, string qualityDistribution)
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<Result> IImagingRepository.GetResultsQualityIndicators(string hRef, string qiParam, string snapshotsParam, string modulesParam, string technologiesParam)
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<Result> IImagingRepository.GetResultsQualityStandardsRules(string hRef, string stgTagParam, string modulesParam, string technologiesParam, bool evolutionSummary)
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<Result> IImagingRepository.GetResultsQualityStandardsTags(string hRef, string stgTagParam)
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<StandardTag> IImagingRepository.GetQualityStandardsTagsDoc(string hRef)
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<StandardTag> IImagingRepository.GetQualityStandardsTagsApplicabilityByCategory(string domain, string category)
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<Result> IImagingRepository.GetResultsSizingMeasures(string hRef, string param, string snapshotsParam, string technologiesParam, string moduleParam)
        {
        ...
        IEnumerable<Result> IImagingRepository.GetResultsBackgroundFacts(string hRef, string param, string snapshotsParam, string technologiesParam, string moduleParam)
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<Result> IImagingRepository.GetOmgTechnicalDebtDetails(string hRef, string indexId, string snapshotId)
        {
        ...
        /// <param name="snapshotId"></param>
        /// <returns></returns>
        IEnumerable<QIQualityRules> IImagingRepository.GetConfQualityRulesBySnapshot(string domainHRef, long snapshotId)
        {
        ...
        /// <param name="href"></param>
        /// <returns></returns>
        QIQualityRules IImagingRepository.GetConfQualityRules(string href)
        {
        ...
        /// <param name="snapshotId"></param>
        /// <returns></returns>
        IEnumerable<QIBusinessCriteria> IImagingRepository.GetConfBusinessCriteriaBySnapshot(string domainHRef, long snapshotId)
        {
            return ListConfiguration<QIBusinessCriteria>(domainHRef, snapshotId, "business-criteria");
        }

        QIBusinessCriteria IImagingRepository.GetConfBusinessCriteria(string href)
        {
