...
;#define App1170Id "{{4F9D45AC-FDAF-4777-AE33-DCB4CBBEABBA}"
#define App1180Id "{{CC05DA45-FE8F-4E84-A0BD-624A2B46ABF4}"
...
begin
    result := false;
    result := UninstallOldVersion('{#App1180Id}', '{#MyAppVersion}');
end;
