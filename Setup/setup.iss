...
#define App1210Id "{{6E5457A9-EA1C-4948-AAC3-2F9AF28B6CED}"
#define App1211Id "{{7BE5F870-30F1-4EE3-BC0B-434B4A18068B}"
...
begin
    result := false;
    result := UninstallOldVersion('{#App1210Id}', '1.21.0');
    result := UninstallOldVersion('{#App1211Id}', '{#MyAppVersion}');
end;
