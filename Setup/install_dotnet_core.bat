...
set DOTNETCORENAME=dotnet-sdk-8.0.410-win-x64
...
rem C:\Windows\System32\curl.exe -o %PACKPATH% https://download.visualstudio.microsoft.com/download/pr/4b3b488c-9e69-4d60-bba2-79412b68d15d/b55f49a270c3413a6ea4b208f820515d/%DOTNETCORENAME%.exe
C:\Windows\System32\curl.exe -o %PACKPATH% https://builds.dotnet.microsoft.com/dotnet/Sdk/8.0.410/%DOTNETCORENAME%.exe
