...
namespace CastReporting.UnitTest.Reporting.Tables
{
    ...
    public class RulesListViolationsBookmarksTableTests
    {
        ...
        public void TestObjectTypeMetric()
        {
            ...
            var expectedData = new List<string>
            { "Rule Name","Object Name","Object Type","Status","Associated Value","File path","Start Line","End Line",
                "Track Classes referencing Database objects","aedtst_exclusions_central.adg_central_grades_std","MyObjType","","O11JNK.LINDBERGH_CENTRAL.VIEWER_ACTIONS,O11JNK.LINDBERGH_CENTRAL.VIEWER_DATA_PERSISTERS","C:\\jenkins6_slave\\workspace\\CAIP_8.3.3_TestE2E_CSS_ADG\\Work\\CAST\\Deploy\\Dream Team\\DssAdmin\\DssAdmin\\MetricTree.cpp","2","6"
            };
