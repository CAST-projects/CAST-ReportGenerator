...
namespace CastReporting.UnitTest.Reporting.Graph
{
    ...
    public class PortfolioGenericGraphTests
    {
        ...
        public void TestOmgTechDebtSample1()
        {
            ...
            expectedData.AddRange(new List<string> { "2 Applications", "3234", "34.3", "158.5" });
            TestUtility.AssertTableContent(table, expectedData, 4, 2);
        }
        ...
        public void TestTechnoOmgTechDebt()
        {
            ...
            expectedData.AddRange(new List<string> { ".NET", "1960", "10.2", "25.7" });
        ...
        public void TestAppTechnoOmgTechDebt()
        {
            ...
            expectedData.AddRange(new List<string> { "    .NET", "10.2", "0" });
            expectedData.AddRange(new List<string> { "    JEE", "0", "20.4" });
            expectedData.AddRange(new List<string> { "    SQL Analyzer", "0", "48.2" });
            TestUtility.AssertTableContent(table, expectedData, 3, 5);
        }
