...
{
    [TestClass]
    public class OmgTrendTechDebtPortfolioTests
    {
        [TestInitialize()]
        ...
        public void TestContent()
        {
            ...
            var component = new OmgTrendTechDebtPortfolio();
            ...
            expectedData.AddRange(new List<string> { quarters[4], "-132.8", "24.1", "1274" });
            expectedData.AddRange(new List<string> { quarters[5], "-25.7", "10.2", "1960" });
        ...
        public void TestContentSameQuarter()
        {
            ...
            expectedData.AddRange(new List<string> { quarters[2], "0", "0", "0" });
            expectedData.AddRange(new List<string> { quarters[3], "0", "0", "0" });
            expectedData.AddRange(new List<string> { quarters[4], "-158.5", "34.3", "3234" });
        ...
        public void TestContentAllQuarters()
        {
            ...
            expectedData.AddRange(new List<string> { quarters[1], "0", "0", "0" });
            expectedData.AddRange(new List<string> { quarters[2], "0", "0", "0" });
            expectedData.AddRange(new List<string> { quarters[3], "-25.7", "10.2", "1960" });
            expectedData.AddRange(new List<string> { quarters[4], "-158.5", "58.400000000000006", "2474.4" });
            expectedData.AddRange(new List<string> { quarters[5], "-132.8", "24.1", "1274" });
